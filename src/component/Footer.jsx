...
const Footer = () => {
  return (
    <div>
      <footer className="footer p-10 bg-opacity-90 bg-violet-900 text-white">
        <nav>
      ...
      <footer className="footer px-10 py-4 border-t bg-image text-white border-base-300">
        <aside className="items-center grid-flow-col">
          ...
          <p>Brand Shop Ltd. <br />Providing reliable Cosmetics & beauty since 2023</p>
        </aside>
